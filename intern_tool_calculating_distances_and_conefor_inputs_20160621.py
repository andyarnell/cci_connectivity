...
##        arcpy.Buffer_analysis (in_features= tempFolder+"/link_shapes/"+tble, out_feature_class= tempFolder+"/link_shapes/"+tbleBff, buffer_distance_or_field = "2 Kilometers", line_end_type = FLAT , {dissolve_option} = "NONE", method= "GEODESIC")
